...
import com.fintrack.moneymanager.repository.ExpenseRepository;
 ...
 // ExpenseService.java
    ...
    public List<ExpenseDTO> getAllExpensesForCurrentUser() {
        ...
        List<ExpenseEntity> list =
                expenseRepository.findByProfile_IdOrderByDateDesc(profile.getId());
    ...
    public List<ExpenseDTO> getCurrentMonthExpenseForCurrentUser() {
        ...
        List<ExpenseEntity> list =
                expenseRepository.findByProfile_IdAndDateBetween(
                        profile.getId(),
                        startDate,
                        endDate
                );
    ...
    public List<ExpenseDTO> getLatest5ExpensesForCurrentUser() {
        ...
        List<ExpenseEntity> list =
                expenseRepository.findTop5ByProfile_IdOrderByDateDesc(profile.getId());
    ...
    public List<ExpenseDTO> filterExpenses(
        ...
        List<ExpenseEntity> list =
                expenseRepository.findByProfile_IdAndDateBetweenAndNameContainingIgnoreCase(
                        profile.getId(),
                        startDate,
                        endDate,
                        keyword,
    ...
    public List<ExpenseDTO> getNotificationsForUserOnDate(Long profileId, LocalDate date) {
        List<ExpenseEntity> list =
                expenseRepository.findByProfile_IdAndDate(profileId, date);
